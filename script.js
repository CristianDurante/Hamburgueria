...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const lanchesData = [
      { name: 'Classic BBQ', image: './Hamburgueres/classicBBQ.jpg', ingredientes: 'Pão brioche, hambúrguer bovino, queijo cheddar, bacon, molho BBQ', preco: 'R$ 20,00' },
      { name: 'Smoked Delight', image: './Hamburgueres/smokedDelight.png', ingredientes: 'Pão australiano, hambúrguer defumado, queijo prato, cebola caramelizada', preco: 'R$ 15,00' },
      { name: 'Cheddar Bacon Blast', image: './Hamburgueres/cheddarBacon.jpg', ingredientes: 'Pão de milho, hambúrguer bovino, cheddar, bacon crocante, maionese especial', preco: 'R$ 10,00'},
      { name: 'Green Ranch', image: './Hamburgueres/greenRanch.jpg', ingredientes: 'Pão integral, hambúrguer de grão-de-bico, alface, tomate, molho ranch.', preco: 'R$ 9,90'},
      { name: 'Triple Cheese Madness', image: './lanches/tripleCheeseMadness.jpg', ingredientes: 'Pão brioche, três tipos de queijo(cheddar, prato,suíço), cebola crispy.', preco: 'R$ 12,00'},
      { name: 'Spicy Volcano', image: './lanches/spicyVolcano.jpeg', ingredientes: 'Pão tradicional, hambúrguer bovino apimentado, queijo cheddar, jalapeños, maionese picante', preco: 'R$ 8,90'},
      { name: 'The Chicken King', image: './Hamburgueres/frango.png', ingredientes: 'Pão de gergelim, filé de frango grelhado, alface, tomate, molho especial', preco: 'R$ 8,90'},
      { name: 'D.Burger Deluxe', image: './lanches/dBurguerDeluxe.jpg', ingredientes: 'Pão brioche, hambúrguer bovino 180g, queijo gouda, rúcula, cebola roxa, maionese de ervas', preco: 'R$ 10,90'}
  ]
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const bebidasData = [
    {
      name: "Coca-Cola",
      image: "https://www.shutterstock.com/image-photo/poznan-pol-aug-13-2019-600nw-2458808941.jpg",
      ingredientes: "Lata 350ml",
      preco: "R$ 6,00",
    },
    {
      name: "Guaraná Antartica",
      image: "https://newtrade.com.br/wp-content/uploads/2015/05/Guarana-Antartica.jpg",
      ingredientes: "Lata 350ml",
      preco: "R$ 5,50",
    },
    {
      name: "Suco de Laranja",
      image: "https://media.istockphoto.com/id/1158980367/pt/foto/woman-hand-pouring-orange-juice-on-glasses-with-slice-orange-on-wooden-background.jpg?s=612x612&w=0&k=20&c=nvOtCjZDsMjKM5DWxXaU5bY2KnUrEXEKUb781sqMG9Q=",
      ingredientes: "Copo 300ml",
      preco: "R$ 8,90",
    },
    {
      name: "Suco de Limão",
      image: "https://www.receiteria.com.br/wp-content/uploads/receitas-de-suco-de-limao.jpg",
      ingredientes: "Copo 300ml",
      preco: "R$ 6,90",
    },
    {
      name: "Água Com Gás",
      image: "https://media.istockphoto.com/id/1303712939/pt/foto/hard-seltzer-cocktail-with-orange-and-zero-waste-bartenders-accessories.jpg?s=612x612&w=0&k=20&c=ZtxG54QfNgYTJFfTiupR4rPu0T2z3KgWs_wPsX8z03k=",
      ingredientes: "600ml",
      preco: "R$ 4,50",
    },
    {
      name: "Água Mineral",
      image: "https://cdn.casapraticaqualita.com.br/wp-content/uploads/sites/2/2019/05/Agua-com-gas.jpg",
      ingredientes: "600ml",
      preco: "R$ 3,90",
    },
    {
      name: "Heineken",
      image: "https://img.freepik.com/fotos-premium/uma-garrafa-de-alcool-verde-com-um-rotulo-que-diz-heineken_900775-9054.jpg",
      ingredientes: "Long Neck 355ml",
      preco: "R$ 12,00",
    },
    {
      name: "Budweiser",
      image: "https://www.shutterstock.com/image-photo/close-seven-bottles-american-beer-600nw-1830434468.jpg",
      ingredientes: "Long Neck 355ml",
      preco: "R$ 10,00",
    },
  ];
